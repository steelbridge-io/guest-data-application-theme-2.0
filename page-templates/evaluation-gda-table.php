<?php
/**
 * Template Name: Evaluation Data Tables
 * Template Post Type: page
 */

get_header(); ?>

<div class="container-fluid guest-data-list-wrapper">
  ...
  <div class="row">
    <div class="col-12">
      <div class="well mt-5 mb-5">
        <?php echo do_shortcode('[custom_search post_type="evaluation-data"]'); ?>
      </div>
    </div>
  </div>
  <div class="row">
